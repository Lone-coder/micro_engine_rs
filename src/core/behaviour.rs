...
impl  Entity {
    ...
    pub fn add_attribute(&mut self, attrb_name : String, value : f32) {
        self.attributes.insert(attrb_name, value);
    }

    pub fn get_attribute(&mut self, attrb_name : String) -> f32 {
        *self.attributes.get(&attrb_name).unwrap()
    }
}
